...
public class DemoController {
    ...
    /**
     * SearchFormオブジェクトのチェック処理オブジェクト
     */
    @Autowired
    private SearchFormCheckValidator searchFormCheckValidator;

    /**
     * DemoFormオブジェクトのチェック処理オブジェクト
     */
    @Autowired
    private DemoFormCheckValidator demoFormCheckValidator;

    /**
     * SearchFormオブジェクトのチェック処理オブジェクトを設定
     * @param binder WebDataバインダ
     */
    @InitBinder("searchForm")
    public void initBinderSearchForm(WebDataBinder binder) {
        binder.addValidators(searchFormCheckValidator);
    }

    /**
     * DemoFormオブジェクトのチェック処理オブジェクトを設定
     * @param binder WebDataバインダ
     */
    @InitBinder("demoForm")
    public void initBinderDemoForm(WebDataBinder binder) {
        binder.addValidators(demoFormCheckValidator);
    }
    ...
    public String search(@Validated SearchForm searchForm, BindingResult result, Model model){
