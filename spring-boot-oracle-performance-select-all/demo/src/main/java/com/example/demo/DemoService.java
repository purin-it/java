...
public class DemoService {
    ...
    public void verifyPerformance() {
        ...
        System.out.println("--- SELECT * によってユーザーデータテーブル(user_data)のデータを全件取得するSQLを実行します start. ---");
        ...
        System.out.println("--- SELECT * によってユーザーデータテーブル(user_data)のデータを全件取得するSQLを実行します end. ---");
        System.out.println();

        System.out.println("--- SELECT (カラム名) によってユーザーデータテーブル(user_data)のデータを全件取得するSQLを実行します start. ---");
        ...
        System.out.println("--- SELECT (カラム名) によってユーザーデータテーブル(user_data)のデータを全件取得するSQLを実行します end. ---");
        System.out.println();

        System.out.println("--- SELECT count(*) によってユーザーデータテーブル(user_data)のデータ件数を取得するSQLを実行します start. ---");
        ...
        System.out.println("--- SELECT count(*) によってユーザーデータテーブル(user_data)のデータ件数を取得するSQLを実行します end. ---");
        System.out.println();

        System.out.println("--- SELECT count((カラム名)) によってユーザーデータテーブル(user_data)のデータ件数を取得するSQLを実行します start. ---");
        ...
        System.out.println("--- SELECT count((カラム名)) によってユーザーデータテーブル(user_data)のデータ件数を取得するSQLを実行します end. ---");
