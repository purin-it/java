...
public class CheckDateValidator implements ConstraintValidator<CheckDate, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {    	
        ...
        String year = String.valueOf((Integer)beanWrapper.getPropertyValue("birthY"));
        String month = String.valueOf((Integer)beanWrapper.getPropertyValue("birthM"));
        String day = String.valueOf((Integer)beanWrapper.getPropertyValue("birthD"));
    	
        // 年・月・日が存在する日付でなければ、エラーメッセージ・エラー項目を設定し
        // falseを返す。そうでなければtrueを返す
        String dateStr = String.valueOf(year) + addZero(month) + addZero(day);
