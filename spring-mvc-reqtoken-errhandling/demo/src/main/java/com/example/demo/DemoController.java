...
public class DemoController {
    ...
    /**
     * 新しい画面を開く
     * @return 新規オープン画面１へのパス
     */
    @RequestMapping(value = "/openNewWindow1", method = RequestMethod.GET)
    ...
    /**
     * 新規オープン画面２に遷移する
     * @return 新規オープン画面２へのパス
     */
    @RequestMapping(value = "/toNewWindow2", method = RequestMethod.POST)
    ...
    /**
     * 新しい画面を開く(エラー確認用)
     * @return 新規オープン画面１(エラー確認用)へのパス
     */
    @RequestMapping(value = "/openNewWindow1Error", method = RequestMethod.GET)
    public String openNewWindow1Error(){
        return "new_window1_error";
    }

    /**
     * 新規オープン画面２(エラー確認用)に遷移する
     * @return 新規オープン画面２(エラー確認用)へのパス
     */
    @RequestMapping(value = "/toNewWindow2Error", method = RequestMethod.POST)
